    ...
    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 me-5">
      <li class="nav-item">
        <div class="nav-link active" aria-current="page">
          <b className="text-color" onClick={moneyTransfer} style={{color:"white"}}>
            Money Transfer
          </b>
          <ToastContainer />
        </div>
      ...
      <li class="nav-item">
        <div class="nav-link active" aria-current="page">
          <b className="text-color" onClick={viewBankAccount} style={{color:"white"}}>
            Bank Account
          </b>
          <ToastContainer />
        </div>
      ...
      <li class="nav-item">
        <div class="nav-link active" aria-current="page">
          <b className="text-color" onClick={handleTransactionHistoryClick} style={{color:"white"}}>
            Transaction History
          </b>
        </div>
      </li>
