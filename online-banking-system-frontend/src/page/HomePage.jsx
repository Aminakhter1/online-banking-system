  ...
  return (
    <div className="container-fluid">
      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-md-8 text-color" style={{backgroundColor:"rgb(101, 51, 143)"}}>
            <h1 style={{color:"black"}}>Welcome to Online Banking System</h1><hr/>
            <p style={{color:"white"}}>
              ...
              transactions, conveniently depositfunds into your accounts, and
        ...
        <div className="row mt-5">
          ...
          <div className="col-md-8 text-color" style={{backgroundColor:"rgb(101, 51, 143)"}}>
            <h1 className="ms-5" style={{color:"black"}}>Experience Effortless Financial Management</h1><hr/>
            <p className="ms-5" style={{color:"white"}}>
